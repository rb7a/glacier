...
const IndexPage = ({display=false}) => {
  ...
  return (
        <Layout title="Build Your Tundra | Glacier International" hideFooter={true} invertNav={true}>
            <Helmet>
                <title>Build Your 2025 Toyota Tundra| Customise Toyota Tundra in NZ</title>
                <meta name='description' content='Experience the new 2025 Toyota Tundra, where luxury meets power. Customise your right-hand drive Toyota Tundra exclusively in NZ at Glacier International today!' />
            </Helmet>
